...
(async () => {
    ...
    await page.type('input[data-testid="SearchBox_Search_Input"]', '#cars', {delay:25});
    
    await page.keyboard.press('Enter');
    
    await page.waitFor(2000)

    // scroll page and collect every profile name
    ...
    // it will visit all profile page and follow 
